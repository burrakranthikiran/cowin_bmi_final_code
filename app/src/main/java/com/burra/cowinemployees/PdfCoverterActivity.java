...
public class PdfCoverterActivity extends AppCompatActivity  {
    ...
    String bmi_name,name_patient_r, formattedDate, gender_value_r,body_FatPercentage_value_r, total_body_water_value_r, bmr_value_r,nutr_status, over_weight, under_weight , spo2, blood_pressure, heart_rate, outputDateString,height_value_r,weight_value_r, bmi_value_r , outputString, inovice_number, today_date, leanBodyMass, metabolic_age, recommandation_data;

    CardView back_icon_bt;
    int age_value_r;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf_coverter2);
        Intent intent = getIntent();
        bmi_name = intent.getStringExtra("bmi_name");
        name_patient_r = intent.getStringExtra("name_patient_r");
        age_value_r = intent.getIntExtra("age_value_r", 0);
        formattedDate = intent.getStringExtra("formattedDate");
        gender_value_r = intent.getStringExtra("gender_value_r");
        height_value_r = intent.getStringExtra("height_value_r");
        weight_value_r = intent.getStringExtra("weight_value_r");
        bmi_value_r = intent.getStringExtra("bmi_value_r");
        ...
        leanBodyMass = intent.getStringExtra("leanBodyMass");
        metabolic_age = intent.getStringExtra("metabolic_age");
        recommandation_data = intent.getStringExtra("recommandation_data");
        webView = findViewById(R.id.webView);
        button = findViewById(R.id.button);
        back_icon_bt = findViewById(R.id.back_icon);
        ...
        countDownTimer = new CountDownTimer(50000 , 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(PdfCoverterActivity.this, MainActivity.class);
                startActivity(intent);
            }
        };
        countDownTimer.start();

        back_icon_bt.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Log.e("9999999999999999999999999999999999", String.valueOf(currentDate));


        // Input string
        String inputString = String.valueOf(currentDate);
        ...
        inovice_number = outputString.replaceAll("[-\\s:]", "");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File pdfFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), inovice_number+"cowin.pdf");

                // Get the content URI using FileProvider
                Uri pdfUri = FileProvider.getUriForFile(getApplicationContext(), "com.burra.cowinemployees", pdfFile);
        ...
        webView.loadDataWithBaseURL(null, "<!DOCTYPE html>\n" +
                ...
                "        </p>\n" +
                "        <p style=\"height:20px; font-weight:500; font-size:16px; font-style:normal; margin-top:0; text-align:center;\">Invoice No :"+ "COWIN-"+inovice_number+ "\n" +
                "        </p>\n" +
                ...
                "            <p style=\"display: inline; margin-left:20px\">:</p>\n" +
                "            <p style=\"display: inline;margin-left:5px;\">"+today_date+"</p>\n" +
                "        </div>\n" +
                ...
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " +Math.round(Float.parseFloat(bmi_value_r)) +"&nbsp KG/M2</p>\n" +
                ...
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " +Math.round(Float.parseFloat(body_FatPercentage_value_r))+"%</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">(21-33)%\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                "                <p style=\"width:180px; display: inline-block;\">Total Body Water</p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " +Math.round(Float.parseFloat(total_body_water_value_r))+"%</p>\n" +
                ...
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " +Math.round(Float.parseFloat(over_weight))+"&nbsp kg"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                "                <p style=\"width:180px; display: inline-block;\">Under weight</p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " +Math.round(Float.parseFloat(under_weight)) +"&nbsp kg"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                ...
                "                </p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " +spo2 + "&nbsp"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">(95-100)%\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                "                <p style=\"width:180px; display: inline-block;\">Heartrate</p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " +heart_rate +"&nbsp"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">(55-70)bpm\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                "                <p style=\"width:180px; display: inline-block;\">Blood presure</p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " + blood_pressure + "&nbsp"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">(120/80)mmHg\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                "                <p style=\"width:180px; display: inline-block;\">Metabolic age</p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " + Math.round(Float.parseFloat(metabolic_age))  + "&nbsp"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                "                <p style=\"width:180px; display: inline-block;\">Skeletal mass</p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " + "NA" + "&nbsp"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">\n" +
                "                </p>\n" +
                "            </div>\n" +
                "            <div style=\"height:15px; margin-left: 80px; margin-top:20px;font-weight:400; font-size:16px; font-style:normal;\">\n" +
                "                <p style=\"width:180px; display: inline-block;\">Lean body mass</p>\n" +
                "                <p style=\"width:180px; display: inline-block;margin-left:90px;\">: " + Math.round(Float.parseFloat(leanBodyMass)) + "&nbsp"+"</p>\n" +
                "                <p style=\"display: inline;margin-left:60px\">\n" +
                "                </p>\n" +
                "            </div>\n" +
                ...
                "                <p style=\"width: 400px; display: inline-block;margin-left:278px;  line-height:20px\">: "+ recommandation_data +"</p>\n" +
                "            </div>\n" +
